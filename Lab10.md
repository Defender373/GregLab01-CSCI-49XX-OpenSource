...
```    
Fetch all records pprint output
```
...
{'_id': ObjectId('56fe9e22bad6b23cde07b8c7'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 46, 41, 484000)],
...
{'_id': ObjectId('56fe9e22bad6b23cde07b8e0'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 48, 54, 230000)],
...
{'_id': ObjectId('56fe9e22bad6b23cde07b8e3'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 43, 14, 989000)],
...
{'_id': ObjectId('56fe9e22bad6b23cde07b8fb'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 46, 57, 621000)],
...
{'_id': ObjectId('56fe9e22bad6b23cde07b921'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 48, 28, 923000)],
...
{'_id': ObjectId('56fe9e22bad6b23cde07b932'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 48, 54, 225000)],
...
{'_id': ObjectId('56fe9e22bad6b23cde07b914'),
 'dates': [datetime.datetime(2019, 4, 6, 2, 45, 59, 244000)],
...
Fetch one records pprint output
```
{'_id': ObjectId('56fe9e22bad6b23cde07b8b8'),
 'definition': ' n. Assemblage of Computer Maniacs, a group of wanted '
               'criminals at the VCC.',
...
Fetch a specific record pprint output
```
<pymongo.cursor.Cursor object at 0x03ABE370>
```

Fetch a record by object id pprint output
```
{'_id': ObjectId('56fe9e22bad6b23cde07b8b8'),
 'definition': ' n. Assemblage of Computer Maniacs, a group of wanted '
               'criminals at the VCC.',
...
Insert a new record pprint output
```
